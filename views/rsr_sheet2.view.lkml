# The name of this view in Looker is "Rsr Sheet2"
view: rsr_sheet2 {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: "MODELLED"."RSR_SHEET2" ;;
  ...
  dimension: _airbyte_rsr_sheet2_hashid {
    type: string
    sql: ${TABLE}."_AIRBYTE_RSR_SHEET2_HASHID" ;;
  }
