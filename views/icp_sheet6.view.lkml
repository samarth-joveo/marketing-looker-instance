# The name of this view in Looker is "Icp Sheet6"
view: icp_sheet6 {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: "MODELLED"."ICP_SHEET6" ;;
  ...
  dimension: _airbyte_icp_sheet6_hashid {
    type: string
    sql: ${TABLE}."_AIRBYTE_ICP_SHEET6_HASHID" ;;
  }
