# The name of this view in Looker is "Fpw Sheet6"
view: fpw_sheet6 {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: "MODELLED"."FPW_SHEET6" ;;
  ...
  dimension: _airbyte_fpw_sheet6_hashid {
    type: string
    sql: ${TABLE}."_AIRBYTE_FPW_SHEET6_HASHID" ;;
  }
