# The name of this view in Looker is "Lpn Sheet7"
view: lpn_sheet7 {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: "MODELLED"."LPN_SHEET7" ;;
  ...
  dimension: _airbyte_lpn_sheet7_hashid {
    type: string
    sql: ${TABLE}."_AIRBYTE_LPN_SHEET7_HASHID" ;;
  }
