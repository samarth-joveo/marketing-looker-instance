# The name of this view in Looker is "Lpn Sheet2"
view: lpn_sheet2 {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: "MODELLED"."LPN_SHEET2" ;;
  ...
  dimension: _airbyte_lpn_sheet2_hashid {
    type: string
    sql: ${TABLE}."_AIRBYTE_LPN_SHEET2_HASHID" ;;
  }
