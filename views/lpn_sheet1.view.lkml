# The name of this view in Looker is "Lpn Sheet1"
view: lpn_sheet1 {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: "MODELLED"."LPN_SHEET1" ;;
  ...
  dimension: _airbyte_lpn_sheet1_hashid {
    type: string
    sql: ${TABLE}."_AIRBYTE_LPN_SHEET1_HASHID" ;;
  }
