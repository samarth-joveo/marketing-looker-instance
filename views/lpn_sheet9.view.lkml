# The name of this view in Looker is "Lpn Sheet9"
view: lpn_sheet9 {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: "MODELLED"."LPN_SHEET9" ;;
  ...
  dimension: _airbyte_lpn_sheet9_hashid {
    type: string
    sql: ${TABLE}."_AIRBYTE_LPN_SHEET9_HASHID" ;;
  }
