# The name of this view in Looker is "Csr Sheet9"
view: csr_sheet9 {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: "MODELLED"."CSR_SHEET9" ;;
  ...
  dimension: _airbyte_csr_sheet9_hashid {
    type: string
    sql: ${TABLE}."_AIRBYTE_CSR_SHEET9_HASHID" ;;
  }
