# The name of this view in Looker is "Lpn Sheet8"
view: lpn_sheet8 {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: "MODELLED"."LPN_SHEET8" ;;
  ...
  dimension: _airbyte_lpn_sheet8_hashid {
    type: string
    sql: ${TABLE}."_AIRBYTE_LPN_SHEET8_HASHID" ;;
  }
