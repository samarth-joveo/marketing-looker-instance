# The name of this view in Looker is "Icp Sheet10"
view: icp_sheet10 {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: "MODELLED"."ICP_SHEET10" ;;
  ...
  dimension: _airbyte_icp_sheet10_hashid {
    type: string
    sql: ${TABLE}."_AIRBYTE_ICP_SHEET10_HASHID" ;;
  }
