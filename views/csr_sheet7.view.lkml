# The name of this view in Looker is "Csr Sheet7"
view: csr_sheet7 {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: "MODELLED"."CSR_SHEET7" ;;
  ...
  dimension: _airbyte_csr_sheet7_hashid {
    type: string
    sql: ${TABLE}."_AIRBYTE_CSR_SHEET7_HASHID" ;;
  }
