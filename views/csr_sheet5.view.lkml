# The name of this view in Looker is "Csr Sheet5"
view: csr_sheet5 {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: "MODELLED"."CSR_SHEET5" ;;
  ...
  dimension: _airbyte_csr_sheet5_hashid {
    type: string
    sql: ${TABLE}."_AIRBYTE_CSR_SHEET5_HASHID" ;;
  }
