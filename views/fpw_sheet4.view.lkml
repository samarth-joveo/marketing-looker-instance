# The name of this view in Looker is "Fpw Sheet4"
view: fpw_sheet4 {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: "MODELLED"."FPW_SHEET4" ;;
  ...
  dimension: _airbyte_fpw_sheet4_hashid {
    type: string
    sql: ${TABLE}."_AIRBYTE_FPW_SHEET4_HASHID" ;;
  }
