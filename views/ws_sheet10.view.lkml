# The name of this view in Looker is "Ws Sheet10"
view: ws_sheet10 {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: "MODELLED"."WS_SHEET10" ;;
  ...
  dimension: _airbyte_ws_sheet10_hashid {
    type: string
    sql: ${TABLE}."_AIRBYTE_WS_SHEET10_HASHID" ;;
  }
