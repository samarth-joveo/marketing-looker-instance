# The name of this view in Looker is "Fpw Sheet2"
view: fpw_sheet2 {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: "MODELLED"."FPW_SHEET2" ;;
  ...
  dimension: _airbyte_fpw_sheet2_hashid {
    type: string
    sql: ${TABLE}."_AIRBYTE_FPW_SHEET2_HASHID" ;;
  }
