# The name of this view in Looker is "Csr Sheet2"
view: csr_sheet2 {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: "MODELLED"."CSR_SHEET2" ;;
  ...
  dimension: _airbyte_csr_sheet2_hashid {
    type: string
    sql: ${TABLE}."_AIRBYTE_CSR_SHEET2_HASHID" ;;
  }
