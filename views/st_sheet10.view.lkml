# The name of this view in Looker is "St Sheet10"
view: st_sheet10 {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: "MODELLED"."ST_SHEET10" ;;
  ...
  dimension: _airbyte_st_sheet10_hashid {
    type: string
    sql: ${TABLE}."_AIRBYTE_ST_SHEET10_HASHID" ;;
  }
