# The name of this view in Looker is "Icp Sheet9"
view: icp_sheet9 {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: "MODELLED"."ICP_SHEET9" ;;
  ...
  dimension: _airbyte_icp_sheet9_hashid {
    type: string
    sql: ${TABLE}."_AIRBYTE_ICP_SHEET9_HASHID" ;;
  }
