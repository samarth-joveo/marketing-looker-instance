# The name of this view in Looker is "Fpw Sheet7"
view: fpw_sheet7 {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: "MODELLED"."FPW_SHEET7" ;;
  ...
  dimension: _airbyte_fpw_sheet7_hashid {
    type: string
    sql: ${TABLE}."_AIRBYTE_FPW_SHEET7_HASHID" ;;
  }
