# The name of this view in Looker is "Fpw Sheet3"
view: fpw_sheet3 {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: "MODELLED"."FPW_SHEET3" ;;
  ...
  dimension: _airbyte_fpw_sheet3_hashid {
    type: string
    sql: ${TABLE}."_AIRBYTE_FPW_SHEET3_HASHID" ;;
  }
