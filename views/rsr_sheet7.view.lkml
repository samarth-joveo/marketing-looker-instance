# The name of this view in Looker is "Rsr Sheet7"
view: rsr_sheet7 {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: "MODELLED"."RSR_SHEET7" ;;
  ...
  dimension: _airbyte_rsr_sheet7_hashid {
    type: string
    sql: ${TABLE}."_AIRBYTE_RSR_SHEET7_HASHID" ;;
  }
