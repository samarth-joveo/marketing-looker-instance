# The name of this view in Looker is "Lpn Sheet4"
view: lpn_sheet4 {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: "MODELLED"."LPN_SHEET4" ;;
  ...
  dimension: _airbyte_lpn_sheet4_hashid {
    type: string
    sql: ${TABLE}."_AIRBYTE_LPN_SHEET4_HASHID" ;;
  }
