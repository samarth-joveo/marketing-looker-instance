# The name of this view in Looker is "Td Sheet10"
view: td_sheet10 {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: "MODELLED"."TD_SHEET10" ;;
  ...
  dimension: _airbyte_td_sheet10_hashid {
    type: string
    sql: ${TABLE}."_AIRBYTE_TD_SHEET10_HASHID" ;;
  }
