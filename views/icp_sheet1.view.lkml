# The name of this view in Looker is "Icp Sheet1"
view: icp_sheet1 {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: "MODELLED"."ICP_SHEET1" ;;
  ...
  dimension: _airbyte_icp_sheet1_hashid {
    type: string
    sql: ${TABLE}."_AIRBYTE_ICP_SHEET1_HASHID" ;;
  }
