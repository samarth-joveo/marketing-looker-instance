# The name of this view in Looker is "Lpn Sheet3"
view: lpn_sheet3 {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: "MODELLED"."LPN_SHEET3" ;;
  ...
  dimension: _airbyte_lpn_sheet3_hashid {
    type: string
    sql: ${TABLE}."_AIRBYTE_LPN_SHEET3_HASHID" ;;
  }
