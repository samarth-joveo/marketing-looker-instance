# The name of this view in Looker is "Csr Sheet10"
view: csr_sheet10 {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: "MODELLED"."CSR_SHEET10" ;;
  ...
  dimension: _airbyte_csr_sheet10_hashid {
    type: string
    sql: ${TABLE}."_AIRBYTE_CSR_SHEET10_HASHID" ;;
  }
