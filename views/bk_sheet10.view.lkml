# The name of this view in Looker is "Bk Sheet10"
view: bk_sheet10 {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: "MODELLED"."BK_SHEET10" ;;
  ...
  dimension: _airbyte_bk_sheet10_hashid {
    type: string
    sql: ${TABLE}."_AIRBYTE_BK_SHEET10_HASHID" ;;
  }
