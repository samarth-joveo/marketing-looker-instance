# The name of this view in Looker is "Csr Sheet4"
view: csr_sheet4 {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: "MODELLED"."CSR_SHEET4" ;;
  ...
  dimension: _airbyte_csr_sheet4_hashid {
    type: string
    sql: ${TABLE}."_AIRBYTE_CSR_SHEET4_HASHID" ;;
  }
