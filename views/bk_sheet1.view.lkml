# The name of this view in Looker is "Bk Sheet1"
view: bk_sheet1 {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: "MODELLED"."BK_SHEET1" ;;
  ...
  dimension: _airbyte_bk_sheet1_hashid {
    type: string
    sql: ${TABLE}."_AIRBYTE_BK_SHEET1_HASHID" ;;
  }
