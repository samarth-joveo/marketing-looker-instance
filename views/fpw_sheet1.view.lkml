# The name of this view in Looker is "Fpw Sheet1"
view: fpw_sheet1 {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: "MODELLED"."FPW_SHEET1" ;;
  ...
  dimension: _airbyte_fpw_sheet1_hashid {
    type: string
    sql: ${TABLE}."_AIRBYTE_FPW_SHEET1_HASHID" ;;
  }
