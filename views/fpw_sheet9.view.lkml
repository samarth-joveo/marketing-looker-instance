# The name of this view in Looker is "Fpw Sheet9"
view: fpw_sheet9 {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: "MODELLED"."FPW_SHEET9" ;;
  ...
  dimension: _airbyte_fpw_sheet9_hashid {
    type: string
    sql: ${TABLE}."_AIRBYTE_FPW_SHEET9_HASHID" ;;
  }
