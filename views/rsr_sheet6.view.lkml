# The name of this view in Looker is "Rsr Sheet6"
view: rsr_sheet6 {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: "MODELLED"."RSR_SHEET6" ;;
  ...
  dimension: _airbyte_rsr_sheet6_hashid {
    type: string
    sql: ${TABLE}."_AIRBYTE_RSR_SHEET6_HASHID" ;;
  }
