# The name of this view in Looker is "Icp Sheet3"
view: icp_sheet3 {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: "MODELLED"."ICP_SHEET3" ;;
  ...
  dimension: _airbyte_icp_sheet3_hashid {
    type: string
    sql: ${TABLE}."_AIRBYTE_ICP_SHEET3_HASHID" ;;
  }
