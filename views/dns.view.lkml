# The name of this view in Looker is "Dns"
view: dns {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: "MODELLED"."DNS" ;;
  ...
  measure: hiring_to_posting_ratio {
    type: average
    sql: ${TABLE}."HIRING_TO_POSTING_RATIO" ;;
  }
