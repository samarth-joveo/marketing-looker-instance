# The name of this view in Looker is "Icp Sheet2"
view: icp_sheet2 {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: "MODELLED"."ICP_SHEET2" ;;
  ...
  dimension: _airbyte_icp_sheet2_hashid {
    type: string
    sql: ${TABLE}."_AIRBYTE_ICP_SHEET2_HASHID" ;;
  }
