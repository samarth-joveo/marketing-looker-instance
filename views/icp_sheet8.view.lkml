# The name of this view in Looker is "Icp Sheet8"
view: icp_sheet8 {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: "MODELLED"."ICP_SHEET8" ;;
  ...
  dimension: _airbyte_icp_sheet8_hashid {
    type: string
    sql: ${TABLE}."_AIRBYTE_ICP_SHEET8_HASHID" ;;
  }
