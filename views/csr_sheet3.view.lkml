# The name of this view in Looker is "Csr Sheet3"
view: csr_sheet3 {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: "MODELLED"."CSR_SHEET3" ;;
  ...
  dimension: _airbyte_csr_sheet3_hashid {
    type: string
    sql: ${TABLE}."_AIRBYTE_CSR_SHEET3_HASHID" ;;
  }
