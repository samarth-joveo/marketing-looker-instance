# The name of this view in Looker is "Fpw Sheet5"
view: fpw_sheet5 {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: "MODELLED"."FPW_SHEET5" ;;
  ...
  dimension: _airbyte_fpw_sheet5_hashid {
    type: string
    sql: ${TABLE}."_AIRBYTE_FPW_SHEET5_HASHID" ;;
  }
