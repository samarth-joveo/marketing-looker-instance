# The name of this view in Looker is "Dsr"
view: dsr {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: "MODELLED"."DSR" ;;
  ...
  measure: percentage_above_or_below_the_national_average {
    type: sum
    sql: ${TABLE}."PERCENTAGE_ABOVE_BELOW_THE_NATIONAL_AVERAGE" ;;
  }
