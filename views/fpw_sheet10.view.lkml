# The name of this view in Looker is "Fpw Sheet10"
view: fpw_sheet10 {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: "MODELLED"."FPW_SHEET10" ;;
  ...
  dimension: _airbyte_fpw_sheet10_hashid {
    type: string
    sql: ${TABLE}."_AIRBYTE_FPW_SHEET10_HASHID" ;;
  }
