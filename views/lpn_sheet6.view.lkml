# The name of this view in Looker is "Lpn Sheet6"
view: lpn_sheet6 {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: "MODELLED"."LPN_SHEET6" ;;
  ...
  dimension: _airbyte_lpn_sheet6_hashid {
    type: string
    sql: ${TABLE}."_AIRBYTE_LPN_SHEET6_HASHID" ;;
  }
