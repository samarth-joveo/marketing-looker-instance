# The name of this view in Looker is "Rsr Sheet10"
view: rsr_sheet10 {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: "MODELLED"."RSR_SHEET10" ;;
  ...
  dimension: _airbyte_rsr_sheet10_hashid {
    type: string
    sql: ${TABLE}."_AIRBYTE_RSR_SHEET10_HASHID" ;;
  }
