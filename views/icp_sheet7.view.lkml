# The name of this view in Looker is "Icp Sheet7"
view: icp_sheet7 {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: "MODELLED"."ICP_SHEET7" ;;
  ...
  dimension: _airbyte_icp_sheet7_hashid {
    type: string
    sql: ${TABLE}."_AIRBYTE_ICP_SHEET7_HASHID" ;;
  }
