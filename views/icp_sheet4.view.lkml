# The name of this view in Looker is "Icp Sheet4"
view: icp_sheet4 {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: "MODELLED"."ICP_SHEET4" ;;
  ...
  dimension: _airbyte_icp_sheet4_hashid {
    type: string
    sql: ${TABLE}."_AIRBYTE_ICP_SHEET4_HASHID" ;;
  }
