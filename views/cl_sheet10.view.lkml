# The name of this view in Looker is "Cl Sheet10"
view: cl_sheet10 {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: "MODELLED"."CL_SHEET10" ;;
  ...
  dimension: _airbyte_cl_sheet10_hashid {
    type: string
    sql: ${TABLE}."_AIRBYTE_CL_SHEET10_HASHID" ;;
  }
