# The name of this view in Looker is "Csr Sheet8"
view: csr_sheet8 {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: "MODELLED"."CSR_SHEET8" ;;
  ...
  dimension: _airbyte_csr_sheet8_hashid {
    type: string
    sql: ${TABLE}."_AIRBYTE_CSR_SHEET8_HASHID" ;;
  }
